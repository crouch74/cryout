import { serializeGame, type CompiledContent, type EngineState } from '../../engine/index.ts';
import { formatNumber, localizeRulesetField, t } from '../i18n/index.ts';
import { presentTerminalOutcome } from './historyPresentation.ts';
      ...
      >
        ...
        <div className="terminal-outcome-actions">
          ...
          <button
            ...
            onClick={() => onExportSave(serializeGame(state))}
          >
            <Icon type="save" size={18} />
            <span>{t('ui.terminal.exportSave', 'Export Save')}</span>
          </button>
