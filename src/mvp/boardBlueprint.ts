...
import { BOARD_REGION_MAP_POINTS } from './worldMapSvgManifest.ts';
...
export const BOARD_REGION_BLUEPRINT: Record<RegionId, BoardRegionBlueprint> = {
  Palestine: {
    ...
    accent: '#b86c5f',
    tilt: -3,
    mapPoint: BOARD_REGION_MAP_POINTS.Palestine,
  ...
  Lebanon: {
    ...
    accent: '#8b6d5d',
    tilt: -6,
    mapPoint: BOARD_REGION_MAP_POINTS.Lebanon,
  ...
  Egypt: {
    ...
    accent: '#9b845d',
    tilt: 2,
    mapPoint: BOARD_REGION_MAP_POINTS.Egypt,
  ...
  Sudan: {
    ...
    accent: '#b87a52',
    tilt: -5,
    mapPoint: BOARD_REGION_MAP_POINTS.Sudan,
  ...
  Congo: {
    ...
    accent: '#8b7a52',
    tilt: 3,
    mapPoint: BOARD_REGION_MAP_POINTS.Congo,
  ...
  Yemen: {
    ...
    accent: '#a77b63',
    tilt: -2,
    mapPoint: BOARD_REGION_MAP_POINTS.Yemen,
  ...
  Sahel: {
    ...
    accent: '#9f8f62',
    tilt: 4,
    mapPoint: BOARD_REGION_MAP_POINTS.Sahel,
  ...
  GulfStates: {
    ...
    accent: '#6d7f8e',
    tilt: -4,
    mapPoint: BOARD_REGION_MAP_POINTS.GulfStates,
