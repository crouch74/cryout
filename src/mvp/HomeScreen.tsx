        ...
        <main className="setup-board-layout">
          <PaperSheet tone="board" className="setup-feature-board">
            ...
            <PaperSheet tone="note">
              ...
              <p>{t('ui.home.replacesBody', 'The product now ships one canonical six-region map, Bodies and Evidence, Global Gaze, Northern War Machine, Extraction Tokens, secret mandates, and Liberation or Symbolic victory.')}</p>
            </PaperSheet>
