...
export const UI_SKINS: Record<UiSkinId, UiSkinDefinition> = {
  ...
  'olive-tree': {
    ...
    effects: {
      heroTone: 'radial-gradient(120% 90% at 14% 8%, rgba(214, 84, 69, 0.26), transparent 58%), linear-gradient(140deg, rgba(20, 31, 18, 0.9), rgba(45, 66, 36, 0.8))',
      backgroundWash: 'rgba(16, 26, 14, 0.34)',
      selectionHighlight: 'rgba(213, 84, 68, 0.3)',
      tokenGlow: 'rgba(191, 154, 75, 0.3)',
      surfaceTint: 'rgba(111, 148, 70, 0.12)',
    },
