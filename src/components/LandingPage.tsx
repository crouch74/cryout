    ...
    return (
        <div className="landing-page">
            ...
            <section className="landing-section">
                <span className="section-label">The Coalition</span>
                ...
                <div className="movements-grid">
                    <div className="movement-card">
                        ...
                        <div className="movement-content">
                            ...
                            <p>
                                Grassroots leaders building solidarity networks on the ground.
                                They turn local despair into collective power, establishing mutual aid hubs and mobilizing the sumud.
                                <strong> Skills:</strong> Relief efforts, solidarity building, and direct action.
                            </p>
                        </div>
                    </div>
                    <div className="movement-card">
                        ...
                        <div className="movement-content">
                            ...
                            <p>
                                The eyes that see what the war machine attempts to hide.
                                They document the truth in real-time, turning raw evidence into a global gaze that protects the vulnerable.
                                <strong> Skills:</strong> Evidence gathering, truth-seeking, and exposing corruption.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="landing-section" style={{ background: 'rgba(255,255,255,0.01)' }}>
                ...
                <h2 className="section-title">The Cycle of Resistance</h2>
                    ...
                    <div className="step-list">
                        <div className="gameplay-step">
                            ...
                            <div className="step-content">
                                ...
                                <p>Every round, the global temperature rises and systemic fronts like 'War' and 'Poverty' exert pressure on vulnerable regions.</p>
                            </div>
                        </div>
                        <div className="gameplay-step">
                            <span className="step-number">02</span>
                            <div className="step-content">
                                <h4>Strategic Intentions</h4>
                                <p>Coordinate your coalition members to commit actions: build relief hubs, gather evidence, or establish mutual aid networks.</p>
                            </div>
                        </div>
                        <div className="gameplay-step">
                            <span className="step-number">03</span>
                            <div className="step-content">
                                <h4>Systemic Resolution</h4>
                                <p>Resolve your actions against the world state. Success builds the Charter of Dignity; failure leads to burnout or displacement.</p>
                            </div>
                        </div>
                    </div>
