  ...
  return (
    ...
    >
      <div className="guidelines-story-grid">
        <ShellSectionCard icon="round" title={t('ui.guide.roundLoop', 'Round Loop')}>
        ...
        <ShellSectionCard icon="buildSolidarity" title={t('ui.guide.coordinationTension', 'Coordination with Tension')}>
        ...
        <ShellSectionCard icon="globalGaze" title={t('ui.guide.boardReading', 'Board Reading')}>
