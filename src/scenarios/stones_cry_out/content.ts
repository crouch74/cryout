...
const domains: DomainDefinition[] = [
  {
    ...
    description: 'Breaking militarism, basing, and the logistics of permanent intervention.',
    initialProgress: 1,
  },
  {
    id: 'DyingPlanet',
    name: 'Earth Defense',
    description: 'Collective defense of land, water, and climate against flood, fire, extraction, and collapse.',
    initialProgress: 1,
  },
  {
    id: 'GildedCage',
    name: 'Carceral Breach',
    description: 'Breaking carceral control, dispossession, and managed rights regimes.',
    initialProgress: 0,
  },
  {
    id: 'SilencedTruth',
    name: 'Open Signal',
    description: 'Keeping evidence, press freedom, and testimony in public circulation.',
    initialProgress: 1,
  },
  {
    id: 'EmptyStomach',
    name: 'Food Sovereignty',
    description: 'Building food sovereignty, debt refusal, and survival beyond austerity.',
    initialProgress: 0,
  },
  {
    id: 'FossilGrip',
    name: 'Extraction Rupture',
    description: 'Advancing energy justice against pipeline rule, sacrifice zones, and fuel empires.',
    initialProgress: 0,
  },
  {
    id: 'StolenVoice',
    name: 'Living Memory',
    description: 'Defending language, art, culture, and collective memory against erasure.',
    initialProgress: 0,
  },
];
