...
import whenTheCorridorsBurnScenario from './when_the_corridors_burn/index.ts';
...
const SCENARIO_MAP = new Map<string, ScenarioModule>([
  ...
  [whenTheCorridorsBurnScenario.metadata.id, withCompatBridge(whenTheCorridorsBurnScenario)],
]);
