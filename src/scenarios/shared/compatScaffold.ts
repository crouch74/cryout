...
export function buildCompatScenarioContent(ruleset: RulesetDefinition): ScenarioContent {
    ...
    zoneDefinitions: Object.fromEntries(ruleset.regions.map((region) => [
      region.id,
      {
        ...
        data: {
          ...
          vulnerability: region.vulnerability as unknown as import('../../engine/types.ts').JsonValue,
        },
      },
    ])),
    assets: {
...
export function buildCompatScenarioSetup(ruleset: RulesetDefinition): ScenarioSetup {
  return {
...
export function buildCompatScenarioRules(): Partial<ScenarioRules> {
  return {
    phases: [
...
export function buildCompatScenarioBehaviors(): ScenarioBehaviors {
  return {
    actionResolvers: {},
    cardResolvers: {},
    deckFactories: {},
...
export function buildCompatScenarioUi(ruleset: RulesetDefinition): ScenarioUiAdapter {
...
export function buildCompatScenarioObservability(ruleset: RulesetDefinition): ScenarioObservability {
  return {
