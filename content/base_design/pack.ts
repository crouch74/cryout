...
const factions: FactionDefinition[] = [
  {
    ...
    homeRegion: 'Congo',
    passive: 'Organize gains +1 Bodies in Congo and Launch Campaign gains +1 there.',
    weakness: 'International Outreach costs +1 Evidence.',
    organizeBonus: 1,
    investigateBonus: 0,
    defenseBonus: 0,
    campaignBonus: 1,
  ...
  },
  {
    ...
    weakness: 'Organize outside the Levant gains -1 Bodies.',
    organizeBonus: 0,
    investigateBonus: 0,
    defenseBonus: 1,
  ...
  },
  {
    ...
    shortName: 'Guardians',
    homeRegion: 'Amazon',
    passive: 'Campaigns in the Amazon or Dying Planet gain +1 and Organize gains +1 Bodies in the Amazon.',
...
const resistanceCards: ResistanceCardDefinition[] = [
  {
    ...
    type: 'action',
    name: 'Archive Leak',
    text: 'Raise Global Gaze by 1 and gain 1 Evidence.',
    effects: [
  ...
  },
  {
    ...
    type: 'action',
    name: 'Radio Uprising',
    text: 'Advance Silenced Truth by 1 and add 1 Body to the target region.',
    effects: [
  ...
  },
  {
    ...
    type: 'action',
    name: 'Strike Fund',
    text: 'Add 3 Bodies to the target region.',
