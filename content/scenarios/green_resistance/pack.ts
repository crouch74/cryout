...
const pack: PackDefinition = {
  ...
  scenario: {
    ...
    introduction:
      'The coalition shifts toward land defenders, river communities, and movement journalists trying to hold the line across Latin America, Sub-Saharan Africa, and the wider climate frontier.',
    story:
    ...
    gameplay:
      'Green Resistance begins with more grassroots capacity than the MENA scenario, but the coalition is spread across more regions and starts with tighter civic space. The challenge is preventing climate and energy escalation from creating a rolling displacement crisis while still investing in culture, legal protection, and long-term infrastructure.',
    mechanics:
      'Root Solidarity turns cultural protection into momentum by generating solidarity at the start of a round once Art & Culture is stabilized. Extraction Spiral punishes ignored climate pressure by pushing fresh displacement into Latin America and Sub-Saharan Africa before the world phase resolves. The scenario rewards distributed institution-building and punishes leaving ecological fronts to drift.',
    moralCenter:
    ...
    specialRuleChips: [
      ...
      },
      {
        ...
        description:
          'When Climate pressure reaches 7 or more, Latin America and Sub-Saharan Africa each gain 1 displacement during the world phase.',
      },
    ],
    roundLimit: {
      CORE: 8,
    ...
    hooks: [
      ...
      },
      {
        ...
        effects: [
          { type: 'add_token', region: 'LatinAmerica', token: 'displacement', count: 1 },
          { type: 'add_token', region: 'SubSaharanAfrica', token: 'displacement', count: 1 },
        ],
      },
    ],
  },
